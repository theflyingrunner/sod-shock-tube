...
// To compile: gcc -Wall -o sod_shock_tube_muscl sod_shock_tube_muscl.c
// To run: ./sod_shock_tube_muscl
...
int main(int argc, char **argv) {
  ...
  printf("Simulation completed. Solution written to 'solution_muscl.txt'.\n");
